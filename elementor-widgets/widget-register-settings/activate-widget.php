...
final class ELEMENTOR_CCWFG_WIDGET {
	...
	//	deactivate_plugins( plugin_basename( ELEMENTOR_CCWFG_WIDGET ) );
...
// Instantiate ELEMENTOR_CCWFG_WIDGET.
new ELEMENTOR_CCWFG_WIDGET();
